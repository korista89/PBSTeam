        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ width: '100%', height: '50px', background: 'white', flexShrink: 0 }} />
                    <img
                        src="/login-banner.png"
                        alt="바르고 건강하게 자립의 꿈을 실현하는 경은학교"
                        style={{ width: '100%', height: '130px', objectFit: 'cover', objectPosition: 'left center', display: 'block', flexShrink: 0 }}
                    />
                    <div style={{ position: 'relative', width: '100%', flex: 1, minHeight: 0, paddingTop: '20px', boxSizing: 'border-box', background: '#FFF5EA' }}>
                        <img
                            src="/hero-bg.png"
                            alt="특수교육 교구 자료"
                            style={{
