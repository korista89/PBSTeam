            ...
            try:
                ...
                for idx, row in enumerate(ws_records):
                    ...
                    form_report_headers = {
                        ...
                        # 2026.9월 하순 실제 구글폼 편집 결과에 맞춰 헤더 문자열을 동기화(직접
                        # 응답해서 확인함) — 아래 세 개는 애초 설계안과 실제 폼 문구가 달랐다.
                        "개별학생교육지원_시간": "[개별학생교육지원] 개별학생교육지원을 실시한 시간 (24시간대기준) - 예: 11:30~12:10 (30분)",
                        "개별학생교육지원_교사": "[개별학생교육지원] 개별학생교육지원을 담당한 교사",
                        "개별학생교육지원_경위": "[개별학생교육지원] 개별학생교육지원을 실시하게 된 경위",
                        "개별학생교육지원_장소_신규": "[개별학생교육지원] 개별학생교육지원 장소",
                        "개별학생교육지원_내용_회복과정": "[개별학생교육지원] 개별학생교육지원 내용 및 회복 과정",
                        "개별학생교육지원_사후조치_특기사항": "[개별학생교육지원] 부상자 치료, 가정학습 등 사후조치 관련 특기사항 (누가 어디를 다쳐서 어떻게 조치했는지)",
