...
대신 위 지침의 내용을 반영하여, 제목·소제목·번호·불릿·"[데이터 한계]" 같은 섹션 표시 없이 자연스럽게 이어지는
정확히 5개의 한국어 문장으로만 작성하라. 데이터 한계나 신뢰도에 관한 내용이 필요하면 그 5개 문장 중 한 문장 안에 자연스럽게 녹여라.
각 문장은 반점(,)으로 여러 절을 길게 잇지 말고 하나의 요지만 담은 짧고 간결한 문장으로 쓴다. 전체 5문장 합계가 250자를 넘지 않게 하라.
학교행동중재지원팀(PBST)이 한눈에 읽고 바로 의사결정에 활용할 수 있도록 핵심 시사점과 실행 가능한 제안만 압축해서 담아라."""
